...
//slight adjustments made by Thorben Quast (thorben.quast@cern.ch) to make compilable with "scram b"
...
cnpy::NpyArray load_the_npz_array(FILE* fp, uint32_t compr_bytes, uint32_t uncompr_bytes) {
    ...
    if (err) {
        std::cout<<"Error has occured while loading the npz array: "<<err<<std::endl;
    }
