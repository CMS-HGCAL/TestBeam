...
/** \class Reco/plugins/HGCalTBRecHitProducerHighGain.h HGCalTBRecHitProducerHighGain HGCalTBRecHitProducerHighGain
	\brief
...
class HGCalTBRecHitProducerHighGain : public edm::EDProducer
{

public:
	HGCalTBRecHitProducerHighGain(const edm::ParameterSet&);
