...
/** \class Reco/plugins/HGCalTBRecHitProducerLowGain.h HGCalTBRecHitProducerLowGain HGCalTBRecHitProducerLowGain
	\brief
...
class HGCalTBRecHitProducerLowGain : public edm::EDProducer
{

public:
	HGCalTBRecHitProducerLowGain(const edm::ParameterSet&);
