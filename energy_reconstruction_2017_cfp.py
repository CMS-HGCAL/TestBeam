...
process.rechitproducer = cms.EDProducer("HGCalTBRecHitProducer",
                                        ...
                                        LG2HG = cms.untracked.vdouble(60./8.,60./8.,60./8.,60./8.),  #based on Artur's e-log entry from 13.06.2017
                                        TOT2LG = cms.untracked.vdouble(8./0.85,8./0.85,8./0.85,8./0.85),   
                                        HighGainADCSaturation = cms.untracked.vdouble(2000,2000,2000,2000),
                                        LowGainADCSaturation = cms.untracked.vdouble(1500,1500,1500,1500),
