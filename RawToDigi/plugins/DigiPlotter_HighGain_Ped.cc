// -*- C++ -*-
//
// Package:    HGCal/DigiPlotter_HighGain_Ped
// Class:      DigiPlotter_HighGain_Ped
//
/**\class DigiPlotter_HighGain_Ped DigiPlotter_HighGain_Ped.cc HGCal/DigiPlotter_HighGain_Ped/plugins/DigiPlotter_HighGain_Ped.cc
...
class DigiPlotter_HighGain_Ped : public edm::one::EDAnalyzer<edm::one::SharedResources>
{

public:
	explicit DigiPlotter_HighGain_Ped(const edm::ParameterSet&);
	~DigiPlotter_HighGain_Ped();
...
//
DigiPlotter_HighGain_Ped::DigiPlotter_HighGain_Ped(const edm::ParameterSet& iConfig)
{
...
DigiPlotter_HighGain_Ped::~DigiPlotter_HighGain_Ped()
{
...
void
DigiPlotter_HighGain_Ped::analyze(const edm::Event& event, const edm::EventSetup& setup)
{
	using namespace edm;
	using namespace std;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        cout<<endl<<" Counter 2 = "<<Cell_counter2_Half<<endl; 
                                             ...
                                             if((SKI.detid()).cellType() == 2 || (SKI.detid()).cellType() == 3 || (SKI.detid()).cellType() == 5 ){
                                                   if((iux <= 0.25 && iyy>= -0.25 ) || (iux < -0.5) )
                                                     ...
                                                     h_digi_layer[nsample][n_layer - 1][event.id().event() - 1]->Fill(iux , iyy, (SKI[nsample].tdc() - (Average_Pedestal_Per_Event1_Full/(Cell_counter1_Full))) );
                                                      else if((iux > -0.25 && iyy < -0.50 ) || (iux > 0.50)) h_digi_layer[nsample][n_layer - 1][event.id().event() - 1]->Fill(iux , iyy, (SKI[nsample].tdc() - (Average_Pedestal_Per_Event2_Full/(Cell_counter2_Full))) );
                                                     }                                  
...
void
DigiPlotter_HighGain_Ped::beginJob()
{
...
void
DigiPlotter_HighGain_Ped::endJob()
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
DigiPlotter_HighGain_Ped::fillDescriptions(edm::ConfigurationDescriptions& descriptions)
{
...
DEFINE_FWK_MODULE(DigiPlotter_HighGain_Ped);
