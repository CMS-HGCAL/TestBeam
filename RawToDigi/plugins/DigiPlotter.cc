...
DigiPlotter::endJob()
{
     ...
     int SENSOR_IV = 0;
     ofstream fs1, fs2;
     fs1.open("/afs/cern.ch/work/r/rchatter/CERN_OneLayer_TestBeam/CMSSW_8_0_1/src/HGCal/Ped_HighGain_L8.txt");
     fs1<<"SCHEME_CODE 0"<<endl;
     fs1<<"# CODE  LAYER SENSOR_IX SENSOR_IV  IX  IV TYPE  VALUE"<<endl;
     fs2.open("/afs/cern.ch/work/r/rchatter/CERN_OneLayer_TestBeam/CMSSW_8_0_1/src/HGCal/Ped_LowGain_L8.txt");
