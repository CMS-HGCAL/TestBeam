   ...
   for(int sk = 1; sk <= 4; sk++){
       ...
       for(int iii = 0; iii < 68; iii++){
           if( iii >= SKI_Channels[sk - 1] ) continue;
                    if(sk == 1) Print_Map_Line(sk + hike,Channel_1[iii],ILayer,sensor_iu,sensor_iv,(IU_1[iii]),(IV_1[iii]),Cell_Type(Channel_1[iii], 1));
                    if(sk == 2) Print_Map_Line(sk + hike,Channel_4[iii],ILayer,sensor_iu,sensor_iv,(IU_4[iii]),(IV_4[iii]),Cell_Type(Channel_4[iii], 4));
		    if(sk == 3) Print_Map_Line(sk + hike,Channel_3[iii],ILayer,sensor_iu,sensor_iv,(IU_3[iii]),(IV_3[iii]),Cell_Type(Channel_3[iii], 3));
		    if(sk == 4) Print_Map_Line(sk + hike,Channel_2[iii],ILayer,sensor_iu,sensor_iv,(IU_2[iii]),(IV_2[iii]),Cell_Type(Channel_2[iii], 2));
