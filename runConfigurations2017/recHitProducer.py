...
process.rechitproducer = cms.EDProducer("HGCalTBRecHitProducer",
                                        ...
                                        LG2HG = cms.untracked.vdouble( [8.0, 8.0, 8.0, 8.0]*20),
                                        TOT2LG = cms.untracked.vdouble([3.0, 3.0, 3.0, 3.0]*20),
                                        HighGainADCSaturation = cms.untracked.vdouble( [2500., 2500., 2500., 2500.]*20),
                                        LowGainADCSaturation = cms.untracked.vdouble([4000.0, 4000.0, 4000.0, 4000.0]*20),
