...
#Thorben Quast, 02 March 2018
#computes high level variables from GAN architectures
...
################################
process = cms.Process("VariableComputer")
...
process.variablecomputation = cms.EDProducer("VariableComputation",
                                RUNDATA = cms.InputTag("source", "FullRunData", "VariableComputer"),
                                HGCALTBRECHITS = cms.InputTag("source", "HGCALTBRECHITS", "VariableComputer"),
                                MWCHAMBERS = cms.InputTag("source","DelayWireChambers", "VariableComputer"),
                                DWCTRACKS = cms.InputTag("dwctrackproducer","HGCalTBDWCTracks", "VariableComputer"),
...
process.p = cms.Path( process.dwctrackproducer * process.variablecomputation * process.ntupelizer)
