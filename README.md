...
* The code runs with the one layer data, and will probably need (major) updates when we will have more layers. 
...
#### Raw data files
* The RAW files can be found in **`/afs/cern.ch/work/b/barneyb/public/data_May_2017/disk2_2TB/eudaq_data`**.
