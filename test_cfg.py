...
#                            fileNames=cms.untracked.vstring("file:Raw_data_New.txt") ### here a vector is provided, but in the .cc only the first one is used TO BE FIXED
                            fileNames=cms.untracked.vstring("file:/afs/cern.ch/user/r/rchatter/public/data/HGC_Output_537.txt") ### here a vector is provided, but in the .cc only the first one is used TO BE FIXED
)
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string("HGC_Output_537_Digi.root") )
#process.TFileService = cms.Service("TFileService", fileName = cms.string("HGC_Output_537_Reco.root") )
process.TFileService = cms.Service("TFileService", fileName = cms.string("HGC_Output_537_Reco_Layer.root") )
#process.TFileService = cms.Service("TFileService", fileName = cms.string("HGC_Output_537_Reco_Display.root") )
