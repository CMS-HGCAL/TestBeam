...
public:
	...
	{
		int skiID = iskiroc();
		return ((HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA-((skiID-1)%HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA))%HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA + ((skiID-1)/HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA)*HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA)%HGCAL_TB_GEOMETRY::N_SKIROC_PER_HEXA;	
	}
